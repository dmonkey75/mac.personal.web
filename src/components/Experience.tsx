                ...
                <div className={classes.wrapper}>
                    ...
                    <div className={classes.content}>
                        <div className={classes.experience}>
                            ...
                            <ul>
                                <li>
                                    <WhiteTextTypography variant='body1' className={classes.items}>Assigned at company's office in Indiana, US in 2016 & 2018 for short term assignment for project handover to continue develop and support legacy systems.</WhiteTextTypography>
                                </li>
                            </ul>
                            <ul>
                                <li>
